...
### dd
_копирование и конвертация файлов. У утилиты много возможностей, в примере создается пустой файл размером 100MB и выводится первые 256 байтов другого файла_
```
